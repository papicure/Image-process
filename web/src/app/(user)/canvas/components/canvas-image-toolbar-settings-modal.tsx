...
export function ImageToolSettingsModal({
    ...
    const previewTools: PreviewTool[] = [
        ...selectedTools,
        { id: "more", title: t("canvas.nodeToolbar.configureQuickTools"), label: t("canvas.nodeToolbar.more"), icon: <Ellipsis className="size-4" />, active: true },
    ];
    ...
    return (
        <Modal
            title={t("canvas.imageToolSettings.title")}
            open={open}
            centered
            width={760}
            onCancel={onCancel}
            ...
            footer={
                <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2">
                        <span>{t("canvas.imageToolSettings.showLabels")}</span>
        ...
        >
            <Typography.Paragraph type="secondary" className="!mb-4">
                {t("canvas.imageToolSettings.description")}
            ...
            <Card
                ...
                title={
                    <Space size={6}>
                        ...
                        {t("canvas.imageToolSettings.preview")}
                    </Space>
                }
                className="mb-4"
            >
                <div className="relative flex min-h-[300px] w-full justify-center pt-20 pb-9">
                    ...
                    >
                        ...
                        <Typography.Text type="secondary">{t("canvas.imageToolSettings.imageNode")}</Typography.Text>
                    </div>
                    <input
            ...
            <Form layout="vertical" className="!mb-0">
                <Form.Item
                    ...
                    label={
                        <Space size={8}>
                            <span>{t("canvas.imageToolSettings.quickTools")}</span>
                            <Tag className="m-0">
